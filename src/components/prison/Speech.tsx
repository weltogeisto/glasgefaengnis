...
export function Speech({ text }: { text: string }) {
  ...
  return (
    <div className="pointer-events-none fixed inset-x-4 z-30 max-h-28 overflow-y-auto bottom-[calc(44dvh+0.7rem)] md:inset-x-auto md:left-8 md:right-[min(28rem,40vw)] md:bottom-10 md:max-h-44">
