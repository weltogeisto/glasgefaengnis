...
export const STORY_CLIPS: StoryClip[] = [
  ...
  },
  {
    ...
    purpose: "Sealed vessel. Occupant trapped inside. A cloth-imprint of a hand strains the silk. No visible hand, no face.",
    section: "jan-mystery",
    status: "batch-2-production",
    ...
    batch: 4,
    sha256: "fc361c74399e85fbc93e6d842dea32fdfbea80290c4e237c8cfb0f31fb36fc23",
    locked: false,
    usedIn: "Phase 2 Jan mystery preview. Same cocoon as the teaser. Occupant is caught inside — only a five-finger cloth imprint, no skin. No face. Awaiting Freigabe.",
  },
  {
