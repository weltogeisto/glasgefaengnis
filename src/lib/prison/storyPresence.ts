...
export const STORY_CLIPS: StoryClip[] = [
  ...
  },
  {
    ...
    purpose: "Closer on the same vessel. A hand bends the silk from inside, trying to escape. No face.",
    section: "jan-mystery",
    status: "batch-2-production",
    ...
    mobileObjectPosition: "52% 50%",
    entryPose: "silk-taut",
    exitPose: "hand-strain",
    playback: "one-shot",
    filename: "nest-cocoon-inner-pulse.mp4",
    batch: 4,
    sha256: "0a70338dff861ad707fe7d37244f45dcc5d85db3d4ea5a8d47b61eff0dd4c64b",
    locked: false,
    usedIn: "Phase 2 Jan mystery preview. Same cocoon as the teaser. Adult hand stretches Urseide from inside. Occupant is not a mount. No face. Awaiting Freigabe.",
  },
  {
