  ...
  return (
    <div className="fixed inset-0 z-20 overflow-y-auto bg-bg text-fg">
      ...
      <main className="mx-auto max-w-6xl px-4 py-6 md:px-8 md:py-8">
        ...
        {current ? <Hero clip={current} onSelect={setActive} /> : null}
...
function Hero({ clip, onSelect }: { clip: StoryClip; onSelect: (id: StoryCueId) => void }) {
        ...
        <div className="relative aspect-video bg-raised">
          ...
          <div className="absolute inset-x-0 bottom-0 flex items-center gap-2 bg-gradient-to-t from-bg to-transparent p-3">
            ...
            <span className="ml-auto font-display text-[0.62rem] uppercase tracking-[0.16em] text-accent">
              {clip.playback} · {(clip.durationMs / 1000).toFixed(1)}s
            </span>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-4 p-5">
          ...
          <div className="mt-auto flex gap-2">
            <button
              ...
              className="inline-flex min-h-11 flex-1 items-center justify-center gap-1 whitespace-nowrap rounded-xl bg-raised font-display text-[0.68rem] uppercase tracking-[0.12em] text-fg"
            >
